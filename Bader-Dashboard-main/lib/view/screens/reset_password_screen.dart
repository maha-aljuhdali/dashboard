  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<AuthCubit,AuthStates>(
        listener: (context,state)
        {
          ...
          {
            showSnackBar(seconds: 25,context: context, message: "تم إرسال رسالة للبريد الإلكتروني لإعادة تعيين كلمة المرور ، الرجاء التحقق منه",backgroundColor: Colors.green);
                              ...
                              [
                                ...
                                MaterialButton(
                                  ...
                                  onPressed: ()
                                  {
                                    ...
                                    {
                                      showSnackBar(context: context, message: "الرجاء إدخال البريد الإلكتروني",backgroundColor: Colors.red);
                                    }
                                  },
                                ),
