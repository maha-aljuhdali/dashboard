    ...
    return Directionality(
      ...
      child: BlocConsumer<DashBoardCubit,DashBoardStates>(
        listener: (context,state)
        {
          ...
          {
            showSnackBar(context: context, message: "حدث خطأ ما اثناء انشاء النادي الرجاء التأكد من حاله الاتصال بالشبكة",backgroundColor: Colors.red,seconds: 5);
          }
        },
                  ...
                  MaterialButton(
                      ...
                      onPressed: ()
                      {
                        if( cubit.clubsNames.contains(clubName.text.trim()) == false )
                          ...
                          {
                            showSnackBar(context: context, message: "الرجاء إدخال البيانات كامله !!",backgroundColor: Colors.red);
                          }
                        else if ( cubit.clubsNames.contains(clubName.text.trim()) == true )
                          {
                            showSnackBar(context: context, message: "الرجاء اختيار اسم أخر للنادي الجديد لوجود نادي بهذا الإسم",backgroundColor: Colors.red);
                          }
                      },
