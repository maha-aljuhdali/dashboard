...
import 'package:badir_app/view/screens/reset_password_screen.dart';
        ...
        builder: (context,state){
          return MaterialButton(
            ...
            onPressed: ()
            {
              ...
              {
                showSnackBar(context: context, message: "الرجاء إدخال البيانات كامله",backgroundColor: Colors.red,seconds: 2);
              }
            },
          );
        },
