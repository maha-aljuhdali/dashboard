            ...
            if( state is AssignLeaderToClubSuccessState )
              {
                cubit.selectedClubName = null;
                cubit.selectedLeaderEmail = null;
                showSnackBar(context: context, message: "تم تعيين المستخدم كقائد",backgroundColor: Colors.green);
                Navigator.pop(context);
              }
            if( state is FailedToAssignLeaderToClubState )
              {
                showSnackBar(context: context, message: "حدث خطأ ما الرجاء المحاولة لاحقًا",backgroundColor: Colors.red);
              }
          },
                    ...
                    MaterialButton(
                        ...
                        async
                        {
                          if( cubit.selectedClubName == null || cubit.selectedLeaderEmail == null )
                            {
                              showSnackBar(context: context, message: "الرجاء ادخال البيانات كاملة",backgroundColor: Colors.red);
                            }
                          else
                            {
